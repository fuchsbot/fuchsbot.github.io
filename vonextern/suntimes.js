...
https://gist.githubusercontent.com/ruiokada/b28076d4911820ddcbbc/raw/b62186cf759177d3e6d8bc2136a65d9b264039e4/suntimes.js
https://github.com/ruiokada
...
var lat="53.225319";
var lng="8.594034";
var tz = (datum.getTimezoneOffset()/60)*-1;
//var tz=2;
let times =suntimes(lat, lng, tz)
let sunrise_hour = Math.floor(times[0]);
let sunrise_minute = (times[0] - Math.floor(times[0])) * 60;

let sundown_hour = Math.floor(times[1]);
let sundown_minute = (times[1] - Math.floor(times[1])) * 60;


var sonnenaufgang = (sunrise_hour+":"+Math.floor(sunrise_minute))
var sonnenuntergang = (sundown_hour+":"+Math.floor(sundown_minute))